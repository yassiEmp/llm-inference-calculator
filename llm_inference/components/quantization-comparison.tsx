  ...
  return (
    <Card>
      <CardContent className="pt-6">
        <h3 className="text-lg font-semibold mb-4">Quantization Method Comparison</h3>
        <p className="text-sm text-muted-foreground mb-4">
          This chart shows the estimated VRAM requirements for different quantization methods with your current model
          configuration ({modelSize}B parameters, {contextLength} context length).
        </p>
        ...
        <div className="mt-4 space-y-2">
          <h4 className="text-sm font-medium">Quantization Method Comparison</h4>
          <ul className="text-sm space-y-1">
            <li>
              <strong>FP32:</strong> Full precision (4 bytes per parameter) - Highest accuracy, highest memory usage
            </li>
            <li>
              <strong>FP16/BF16:</strong> Half precision (2 bytes per parameter) - Good balance of accuracy and memory
            </li>
            <li>
              <strong>INT8:</strong> 8-bit quantization (1 byte per parameter) - Reduced accuracy, significant memory
              savings
            </li>
            <li>
              <strong>INT4:</strong> 4-bit quantization (0.5 bytes per parameter) - Further reduced accuracy, maximum
              memory savings
            </li>
            <li>
              <strong>GPTQ:</strong> Optimized quantization with varying precision - Good accuracy with memory savings
              similar to INT4
            </li>
          </ul>
        </div>
